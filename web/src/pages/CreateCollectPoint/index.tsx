...
const ibgeUFUrl = 'https://servicodados.ibge.gov.br/api/v1/localidades/estados';
...
const CreateCollectPoint = () => {
  ...
  useEffect(() => {
    axios.get<IBGEUFResponse[]>(ibgeUFUrl).then(response => {
        ...
        <fieldset>
          <legend>
            <div style={{ display: 'flex', justifyContent: 'inherit' }}>
              <h2>Endereço</h2>
              <span style={{ marginTop: 'auto' }}>Selecione o endereço no mapa</span>
            </div>
          </legend>
        ...
        <fieldset>
          <legend>
            <div style={{ display: 'flex', justifyContent: 'inherit' }}>
              ...
              <span style={{ marginTop: 'auto' }}>Selecione um ou mais items abaixo</span>
            </div>
          </legend>
